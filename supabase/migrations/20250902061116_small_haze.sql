/*
  # Initialize Fleet Maintenance Database

  1. New Tables
    - `vehicles` - Fleet vehicle information with service tracking
    - `technicians` - Maintenance technician details and assignments  
    - `maintenance_tasks` - Task management with photos and completion tracking
  ...
  3. Sample Data
    - 12 sample vehicles across different types and locations
    - 5 sample technicians with depot assignments
    - 3 sample maintenance tasks in various states
...
INSERT INTO maintenance_tasks (
  ...
  parts_used, digital_signature, notes
) VALUES
  (
  ...
  (
    ...
    'Sarah Chen', 'Battery replaced successfully. All electrical systems functioning normally.'
  )
ON CONFLICT (id) DO NOTHING;